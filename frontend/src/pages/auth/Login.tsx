  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4">
      ...
      <div className="w-full max-w-md">
        <h1 className="text-3xl font-semibold text-center mb-2">Log in to your account</h1>
        <p className="text-center text-gray-600 mb-8">Welcome back to TestCraft AI</p>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            Don't have an account? 
            <Link to="/signup" className="text-teal-800 ml-1 hover:underline">
              Sign up
            </Link>
          </p>
        </div>
